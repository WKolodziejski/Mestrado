...
enum {
  ...
  encode_b_nonrd_time,
  warped_causal_tool_time,
  warped_causal_pred_time,
...
static INLINE char const *get_component_name(int index) {
  switch (index) {
    ...
    case warped_causal_tool_time: return "warped_causal_tool_time";
    case warped_causal_pred_time: return "warped_causal_pred_time";
