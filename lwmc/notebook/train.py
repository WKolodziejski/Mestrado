...
features_drop = [
    'xd__above_mbmi__bsize',
    'xd__above_mbmi__interintra_mode',
    'xd__above_mbmi__interp_filters__as_filters__x_filter',
    'xd__above_mbmi__interp_filters__as_filters__y_filter',
    'xd__above_mbmi__mode',
    'xd__above_mbmi__motion_mode',
    'xd__above_mbmi__partition',
    'xd__above_mbmi__uv_mode',
    'xd__left_mbmi__bsize',
    'xd__left_mbmi__interintra_mode',
    'xd__left_mbmi__interp_filters__as_filters__x_filter',
    'xd__left_mbmi__interp_filters__as_filters__y_filter',
    'xd__left_mbmi__mode',
    'xd__left_mbmi__motion_mode',
    'xd__left_mbmi__partition',
    'xd__left_mbmi__uv_mode'
]
...
def train(dataset_train: str,
          ...
          do_important_features: bool = True,
