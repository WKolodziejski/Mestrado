...
void collect_finalize(struct features_interp_filters *features) {
  ...
  if (strcmp("OBMC", features->mbmi__motion_mode) != 0) return;
...
void collect_filename(const char *fn) {
  strcpy(filename, fn);
  strcat(filename, "_obmc");
  strcat(filename, ".csv");

  FILE *file = fopen(filename, "w");

  fprintf(file,
          "bsize,ref_best_rd,ref_skip_rd,best_est_rd,do_tx_search,rate_mv,num_planes,is_comp_pred,rate2_nocoeff,interintra_allowed,txfm_rd_gate_level,update_type,x__qindex,x__delta_qindex,x__rdmult_delta_qindex,x__rdmult_cur_qindex,x__rdmult,x__intra_sb_rdmult_modifier,x__rb,x__mb_energy,x__sb_energy_level,x__errorperbit,x__sadperbit,x__seg_skip_block,x__actual_num_seg1_blocks,x__actual_num_seg2_blocks,x__cnt_zeromv,x__force_zeromv_skip_for_sb,x__force_zeromv_skip_for_blk,x__nonrd_prune_ref_frame_search,x__must_find_valid_partition,x__skip_mode,x__winner_mode_count,x__recalc_luma_mc_data,x__reuse_inter_pred,x__source_variance,x__block_is_zero_sad,x__sb_me_partition,x__sb_me_block,x__sb_force_fixed_part,x__try_merge_partition,x__palette_pixels,x__plane__0__src_diff,x__plane__0__dqcoeff,x__plane__0__qcoeff,x__plane__0__coeff,x__plane__0__eobs,x__plane__0__quant_fp_QTX,x__plane__0__round_fp_QTX,x__plane__0__quant_QTX,x__plane__0__round_QTX,x__plane__0__quant_shift_QTX,x__plane__0__zbin_QTX,x__plane__0__dequant_QTX,xd__mi_row,xd__mi_col,xd__mi_stride,xd__is_chroma_ref,xd__up_available,xd__left_available,xd__chroma_up_available,xd__chroma_left_available,xd__tx_type_map_stride,xd__mb_to_left_edge,xd__mb_to_right_edge,xd__mb_to_top_edge,xd__mb_to_bottom_edge,xd__width,xd__height,xd__is_last_vertical_rect,xd__is_first_horizontal_rect,xd__bd,xd__current_base_qindex,xd__cur_frame_force_integer_mv,xd__delta_lf_from_base,xd__block_ref_scale_factors__0__x_scale_fp,xd__block_ref_scale_factors__0__y_scale_fp,xd__block_ref_scale_factors__0__x_step_q4,xd__block_ref_scale_factors__0__y_step_q4,xd__block_ref_scale_factors__1__x_scale_fp,xd__block_ref_scale_factors__1__y_scale_fp,xd__block_ref_scale_factors__1__x_step_q4,xd__block_ref_scale_factors__1__y_step_q4,xd__plane__0__plane_type,xd__plane__0__subsampling_x,xd__plane__0__width,xd__plane__0__height,xd__plane__1__plane_type,xd__plane__1__subsampling_x,xd__plane__1__width,xd__plane__1__height,xd__plane__2__plane_type,xd__plane__2__subsampling_x,xd__plane__2__width,xd__plane__2__height,xd__tile__mi_row_start,xd__tile__mi_row_end,xd__tile__mi_col_start,xd__tile__mi_col_end,xd__tile__tile_row,xd__tile__tile_col,mbmi__bsize,mbmi__partition,mbmi__mode,mbmi__uv_mode,mbmi__current_qindex,mbmi__motion_mode,mbmi__num_proj_ref,mbmi__overlappable_neighbors,mbmi__interintra_mode,mbmi__interintra_wedge_index,mbmi__cfl_alpha_signs,mbmi__cfl_alpha_idx,mbmi__skip_txfm,mbmi__tx_size,mbmi__ref_mv_idx,mbmi__skip_mode,mbmi__use_intrabc,mbmi__comp_group_idx,mbmi__compound_idx,mbmi__use_wedge_interintra,mbmi__cdef_strength,mbmi__interp_filters__as_filters__y_filter,mbmi__interp_filters__as_filters__x_filter,mbmi__mv__0__as_mv__row,mbmi__mv__1__as_mv__col,xd__left_mbmi__bsize,xd__left_mbmi__partition,xd__left_mbmi__mode,xd__left_mbmi__uv_mode,xd__left_mbmi__current_qindex,xd__left_mbmi__motion_mode,xd__left_mbmi__num_proj_ref,xd__left_mbmi__overlappable_neighbors,xd__left_mbmi__interintra_mode,xd__left_mbmi__interintra_wedge_index,xd__left_mbmi__cfl_alpha_signs,xd__left_mbmi__cfl_alpha_idx,xd__left_mbmi__skip_txfm,xd__left_mbmi__tx_size,xd__left_mbmi__ref_mv_idx,xd__left_mbmi__skip_mode,xd__left_mbmi__use_intrabc,xd__left_mbmi__comp_group_idx,xd__left_mbmi__compound_idx,xd__left_mbmi__use_wedge_interintra,xd__left_mbmi__cdef_strength,xd__left_mbmi__interp_filters__as_filters__y_filter,xd__left_mbmi__interp_filters__as_filters__x_filter,xd__left_mbmi__mv__0__as_mv__row,xd__left_mbmi__mv__1__as_mv__col,xd__above_mbmi__bsize,xd__above_mbmi__partition,xd__above_mbmi__mode,xd__above_mbmi__uv_mode,xd__above_mbmi__current_qindex,xd__above_mbmi__motion_mode,xd__above_mbmi__num_proj_ref,xd__above_mbmi__overlappable_neighbors,xd__above_mbmi__interintra_mode,xd__above_mbmi__interintra_wedge_index,xd__above_mbmi__cfl_alpha_signs,xd__above_mbmi__cfl_alpha_idx,xd__above_mbmi__skip_txfm,xd__above_mbmi__tx_size,xd__above_mbmi__ref_mv_idx,xd__above_mbmi__skip_mode,xd__above_mbmi__use_intrabc,xd__above_mbmi__comp_group_idx,xd__above_mbmi__compound_idx,xd__above_mbmi__use_wedge_interintra,xd__above_mbmi__cdef_strength,xd__above_mbmi__interp_filters__as_filters__y_filter,xd__above_mbmi__interp_filters__as_filters__x_filter,xd__above_mbmi__mv__0__as_mv__row,xd__above_mbmi__mv__1__as_mv__col,rd_stats__rate,rd_stats__zero_rate,rd_stats__dist,rd_stats__rdcost,rd_stats__sse,rd_stats__skip_txfm,rd_stats_y__rate,rd_stats_y__zero_rate,rd_stats_y__dist,rd_stats_y__rdcost,rd_stats_y__sse,rd_stats_y__skip_txfm,rd_stats_uv__zero_rate,rd_stats_uv__dist,rd_stats_uv__rdcost,rd_stats_uv__sse,rd_stats_uv__skip_txfm,cpi__skip_tpl_setup_stats,cpi__tpl_rdmult_scaling_factors,cpi__rt_reduce_num_ref_buffers,cpi__framerate,cpi__ref_frame_flags,cpi__speed,cpi__all_one_sided_refs,cpi__gf_frame_index,cpi__droppable,cpi__data_alloc_width,cpi__data_alloc_height,cpi__initial_mbs,cpi__frame_size_related_setup_done,cpi__last_coded_width,cpi__last_coded_height,cpi__num_frame_recode,cpi__intrabc_used,cpi__prune_ref_frame_mask,cpi__use_screen_content_tools,cpi__is_screen_content_type,cpi__frame_header_count,cpi__deltaq_used,cpi__last_frame_type,cpi__num_tg,cpi__superres_mode,cpi__fp_block_size,cpi__sb_counter,cpi__ref_refresh_index,cpi__refresh_idx_available,cpi__ref_idx_to_skip,cpi__do_frame_data_update,cpi__ext_rate_scale,cpi__weber_bsize,cpi__norm_wiener_variance,cpi__is_dropped_frame,cpi__rec_sse,cpi__frames_since_last_update,cpi__palette_pixel_num,cpi__scaled_last_source_available,cpi__ppi__ts_start_last_show_frame,cpi__ppi__ts_end_last_show_frame,cpi__ppi__num_fp_contexts,cpi__ppi__filter_level__0,cpi__ppi__filter_level__1,cpi__ppi__filter_level_u,cpi__ppi__filter_level_v,cpi__ppi__seq_params_locked,cpi__ppi__internal_altref_allowed,cpi__ppi__show_existing_alt_ref,cpi__ppi__lap_enabled,cpi__ppi__b_calculate_psnr,cpi__ppi__frames_left,cpi__ppi__use_svc,cpi__ppi__buffer_removal_time_present,cpi__ppi__number_temporal_layers,cpi__ppi__number_spatial_layers,cpi__ppi__tpl_sb_rdmult_scaling_factors,cpi__ppi__gf_group__max_layer_depth,cpi__ppi__gf_group__max_layer_depth_allowed,cpi__ppi__gf_state__arf_gf_boost_lst,cpi__ppi__twopass__section_intra_rating,cpi__ppi__twopass__first_pass_done,cpi__ppi__twopass__bits_left,cpi__ppi__twopass__modified_error_min,cpi__ppi__twopass__modified_error_max,cpi__ppi__twopass__modified_error_left,cpi__ppi__twopass__kf_group_bits,cpi__ppi__twopass__kf_group_error_left,cpi__ppi__twopass__bpm_factor,cpi__ppi__twopass__rolling_arf_group_target_bits,cpi__ppi__twopass__rolling_arf_group_actual_bits,cpi__ppi__twopass__sr_update_lag,cpi__ppi__twopass__kf_zeromotion_pct,cpi__ppi__twopass__last_kfgroup_zeromotion_pct,cpi__ppi__twopass__extend_minq,cpi__ppi__twopass__extend_maxq,cpi__ppi__twopass__firstpass_info__total_stats__frame,cpi__ppi__twopass__firstpass_info__total_stats__weight,cpi__ppi__twopass__firstpass_info__total_stats__intra_error,cpi__ppi__twopass__firstpass_info__total_stats__frame_avg_wavelet_energy,cpi__ppi__twopass__firstpass_info__total_stats__coded_error,cpi__ppi__twopass__firstpass_info__total_stats__sr_coded_error,cpi__ppi__twopass__firstpass_info__total_stats__pcnt_inter,cpi__ppi__twopass__firstpass_info__total_stats__pcnt_motion,cpi__ppi__twopass__firstpass_info__total_stats__pcnt_second_ref,cpi__ppi__twopass__firstpass_info__total_stats__pcnt_neutral,cpi__ppi__twopass__firstpass_info__total_stats__intra_skip_pct,cpi__ppi__twopass__firstpass_info__total_stats__inactive_zone_rows,cpi__ppi__twopass__firstpass_info__total_stats__inactive_zone_cols,cpi__ppi__twopass__firstpass_info__total_stats__MVr,cpi__ppi__twopass__firstpass_info__total_stats__mvr_abs,cpi__ppi__twopass__firstpass_info__total_stats__MVc,cpi__ppi__twopass__firstpass_info__total_stats__mvc_abs,cpi__ppi__twopass__firstpass_info__total_stats__MVrv,cpi__ppi__twopass__firstpass_info__total_stats__MVcv,cpi__ppi__twopass__firstpass_info__total_stats__mv_in_out_count,cpi__ppi__twopass__firstpass_info__total_stats__new_mv_count,cpi__ppi__twopass__firstpass_info__total_stats__duration,cpi__ppi__twopass__firstpass_info__total_stats__count,cpi__ppi__twopass__firstpass_info__total_stats__raw_error_stdev,cpi__ppi__twopass__firstpass_info__total_stats__is_flash,cpi__ppi__twopass__firstpass_info__total_stats__noise_var,cpi__ppi__twopass__firstpass_info__total_stats__cor_coeff,cpi__ppi__twopass__firstpass_info__total_stats__log_intra_error,cpi__ppi__twopass__firstpass_info__total_stats__log_coded_error,cpi__ppi__p_rc__gf_group_bits,cpi__ppi__p_rc__kf_boost,cpi__ppi__p_rc__gfu_boost,cpi__ppi__p_rc__cur_gf_index,cpi__ppi__p_rc__num_regions,cpi__ppi__p_rc__regions_offset,cpi__ppi__p_rc__frames_till_regions_update,cpi__ppi__p_rc__baseline_gf_interval,cpi__ppi__p_rc__constrained_gf_group,cpi__ppi__p_rc__this_key_frame_forced,cpi__ppi__p_rc__next_key_frame_forced,cpi__ppi__p_rc__starting_buffer_level,cpi__ppi__p_rc__optimal_buffer_level,cpi__ppi__p_rc__maximum_buffer_size,cpi__ppi__p_rc__arf_q,cpi__ppi__p_rc__arf_boost_factor,cpi__ppi__p_rc__base_layer_qp,cpi__ppi__p_rc__num_stats_used_for_kf_boost,cpi__ppi__p_rc__num_stats_used_for_gfu_boost,cpi__ppi__p_rc__num_stats_required_for_gfu_boost,cpi__ppi__p_rc__enable_scenecut_detection,cpi__ppi__p_rc__use_arf_in_this_kf_group,cpi__ppi__p_rc__ni_frames,cpi__ppi__p_rc__tot_q,cpi__ppi__p_rc__last_kf_qindex,cpi__ppi__p_rc__last_boosted_qindex,cpi__ppi__p_rc__avg_q,cpi__ppi__p_rc__total_actual_bits,cpi__ppi__p_rc__total_target_bits,cpi__ppi__p_rc__buffer_level,cpi__ppi__p_rc__rate_error_estimate,cpi__ppi__p_rc__vbr_bits_off_target,cpi__ppi__p_rc__vbr_bits_off_target_fast,cpi__ppi__p_rc__bits_off_target,cpi__ppi__p_rc__rolling_target_bits,cpi__ppi__p_rc__rolling_actual_bits,cpi__ppi__tf_info__is_temporal_filter_on,cpi__ppi__tf_info__frame_diff__0__sum,cpi__ppi__tf_info__frame_diff__0__sse,cpi__ppi__tf_info__frame_diff__1__sum,cpi__ppi__tf_info__frame_diff__1__sse,cpi__ppi__tf_info__tf_buf_gf_index__0,cpi__ppi__tf_info__tf_buf_gf_index__1,cpi__ppi__tf_info__tf_buf_display_index_offset__0,cpi__ppi__tf_info__tf_buf_display_index_offset__1,cpi__ppi__tf_info__tf_buf_valid__0,cpi__ppi__tf_info__tf_buf_valid__1,cpi__ppi__seq_params__num_bits_width,cpi__ppi__seq_params__num_bits_height,cpi__ppi__seq_params__max_frame_width,cpi__ppi__seq_params__max_frame_height,cpi__ppi__seq_params__frame_id_numbers_present_flag,cpi__ppi__seq_params__frame_id_length,cpi__ppi__seq_params__delta_frame_id_length,cpi__ppi__seq_params__sb_size,cpi__ppi__seq_params__mib_size,cpi__ppi__seq_params__mib_size_log2,cpi__ppi__seq_params__force_screen_content_tools,cpi__ppi__seq_params__still_picture,cpi__ppi__seq_params__reduced_still_picture_hdr,cpi__ppi__seq_params__force_integer_mv,cpi__ppi__seq_params__enable_filter_intra,cpi__ppi__seq_params__enable_intra_edge_filter,cpi__ppi__seq_params__enable_interintra_compound,cpi__ppi__seq_params__enable_masked_compound,cpi__ppi__seq_params__enable_dual_filter,cpi__ppi__seq_params__enable_warped_motion,cpi__ppi__seq_params__enable_superres,cpi__ppi__seq_params__enable_cdef,cpi__ppi__seq_params__enable_restoration,cpi__ppi__seq_params__profile,cpi__ppi__seq_params__bit_depth,cpi__ppi__seq_params__use_highbitdepth,cpi__ppi__seq_params__monochrome,cpi__ppi__seq_params__color_primaries,cpi__ppi__seq_params__transfer_characteristics,cpi__ppi__seq_params__matrix_coefficients,cpi__ppi__seq_params__color_range,cpi__ppi__seq_params__subsampling_x,cpi__ppi__seq_params__subsampling_y,cpi__ppi__seq_params__chroma_sample_position,cpi__ppi__seq_params__separate_uv_delta_q,cpi__ppi__seq_params__film_grain_params_present,cpi__ppi__seq_params__operating_points_cnt_minus_1,cpi__ppi__seq_params__has_nonzero_operating_point_idc,cpi__ppi__tpl_data__ready,cpi__ppi__tpl_data__tpl_stats_block_mis_log2,cpi__ppi__tpl_data__tpl_bsize_1d,cpi__ppi__tpl_data__frame_idx,cpi__ppi__tpl_data__border_in_pixels,cpi__ppi__tpl_data__r0_adjust_factor,cpi__ppi__tpl_data__tpl_frame__is_valid,cpi__ppi__tpl_data__tpl_frame__stride,cpi__ppi__tpl_data__tpl_frame__width,cpi__ppi__tpl_data__tpl_frame__height,cpi__ppi__tpl_data__tpl_frame__mi_rows,cpi__ppi__tpl_data__tpl_frame__mi_cols,cpi__ppi__tpl_data__tpl_frame__base_rdmult,cpi__ppi__tpl_data__tpl_frame__frame_display_index,cpi__ppi__tpl_data__tpl_frame__use_pred_sad,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__srcrf_sse,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__srcrf_dist,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__recrf_sse,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__recrf_dist,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__intra_sse,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__intra_dist,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__mc_dep_rate,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__mc_dep_dist,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__intra_cost,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__inter_cost,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__srcrf_rate,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__recrf_rate,cpi__ppi__tpl_data__tpl_frame__tpl_stats_ptr__intra_rate,cpi__ppi__tpl_data__sf__x_scale_fp,cpi__ppi__tpl_data__sf__y_scale_fp,cpi__ppi__tpl_data__sf__x_step_q4,cpi__ppi__tpl_data__sf__y_step_q4,cpi__common__width,cpi__common__height,cpi__common__render_width,cpi__common__render_height,cpi__common__superres_upscaled_width,cpi__common__superres_upscaled_height,cpi__common__superres_scale_denominator,cpi__common__frame_presentation_time,cpi__common__show_frame,cpi__common__showable_frame,cpi__common__show_existing_frame,cpi__common__current_frame__frame_type,cpi__common__current_frame__reference_mode,cpi__common__current_frame__order_hint,cpi__common__current_frame__display_order_hint,cpi__common__current_frame__pyramid_level,cpi__common__current_frame__frame_number,cpi__common__current_frame__refresh_frame_flags,cpi__common__current_frame__frame_refs_short_signaling,cpi__common__sf_identity__x_scale_fp,cpi__common__sf_identity__y_scale_fp,cpi__common__sf_identity__x_step_q4,cpi__common__sf_identity__y_step_q4,cpi__common__features__disable_cdf_update,cpi__common__features__allow_high_precision_mv,cpi__common__features__cur_frame_force_integer_mv,cpi__common__features__allow_screen_content_tools,cpi__common__features__allow_intrabc,cpi__common__features__allow_warped_motion,cpi__common__features__allow_ref_frame_mvs,cpi__common__features__coded_lossless,cpi__common__features__all_lossless,cpi__common__features__reduced_tx_set_used,cpi__common__features__error_resilient_mode,cpi__common__features__switchable_motion_mode,cpi__common__features__tx_mode,cpi__common__features__interp_filter,cpi__common__features__primary_ref_frame,cpi__common__features__byte_alignment,cpi__common__features__refresh_frame_context,cpi__common__mi_params__mb_rows,cpi__common__mi_params__mb_cols,cpi__common__mi_params__MBs,cpi__common__mi_params__mi_rows,cpi__common__mi_params__mi_cols,cpi__common__mi_params__mi_stride,cpi__oxcf__noise_level,cpi__oxcf__noise_block_size,cpi__oxcf__enable_dnl_denoising,cpi__oxcf__tier_mask,cpi__oxcf__border_in_pixels,cpi__oxcf__max_threads,cpi__oxcf__speed,cpi__oxcf__profile,cpi__oxcf__pass,cpi__oxcf__passes,cpi__oxcf__mode,cpi__oxcf__use_highbitdepth,cpi__oxcf__save_as_annexb,cpi__oxcf__input_cfg__init_framerate,cpi__oxcf__input_cfg__input_bit_depth,cpi__oxcf__input_cfg__limit,cpi__oxcf__input_cfg__chroma_subsampling_x,cpi__oxcf__input_cfg__chroma_subsampling_y,cpi__oxcf__algo_cfg__sharpness,cpi__oxcf__algo_cfg__disable_trellis_quant,cpi__oxcf__algo_cfg__arnr_max_frames,cpi__oxcf__algo_cfg__arnr_strength,cpi__oxcf__algo_cfg__cdf_update_mode,cpi__oxcf__algo_cfg__enable_tpl_model,cpi__oxcf__algo_cfg__enable_overlay,cpi__oxcf__algo_cfg__loopfilter_control,cpi__oxcf__algo_cfg__skip_postproc_filtering,cpi__oxcf__rc_cfg__starting_buffer_level_ms,cpi__oxcf__rc_cfg__optimal_buffer_level_ms,cpi__oxcf__rc_cfg__maximum_buffer_size_ms,cpi__oxcf__rc_cfg__target_bandwidth,cpi__oxcf__rc_cfg__vbr_corpus_complexity_lap,cpi__oxcf__rc_cfg__max_intra_bitrate_pct,cpi__oxcf__rc_cfg__max_inter_bitrate_pct,cpi__oxcf__rc_cfg__gf_cbr_boost_pct,cpi__oxcf__rc_cfg__min_cr,cpi__oxcf__rc_cfg__drop_frames_water_mark,cpi__oxcf__rc_cfg__under_shoot_pct,cpi__oxcf__rc_cfg__over_shoot_pct,cpi__oxcf__rc_cfg__worst_allowed_q,cpi__oxcf__rc_cfg__best_allowed_q,cpi__oxcf__rc_cfg__cq_level,cpi__oxcf__rc_cfg__mode,cpi__oxcf__rc_cfg__vbrbias,cpi__oxcf__rc_cfg__vbrmin_section,cpi__oxcf__rc_cfg__vbrmax_section,cpi__oxcf__q_cfg__use_fixed_qp_offsets,cpi__oxcf__q_cfg__qm_minlevel,cpi__oxcf__q_cfg__qm_maxlevel,cpi__oxcf__q_cfg__quant_b_adapt,cpi__oxcf__q_cfg__aq_mode,cpi__oxcf__q_cfg__deltaq_mode,cpi__oxcf__q_cfg__deltaq_strength,cpi__oxcf__q_cfg__enable_chroma_deltaq,cpi__oxcf__q_cfg__enable_hdr_deltaq,cpi__oxcf__q_cfg__using_qm,cpi__tf_ctx__num_frames,cpi__tf_ctx__noise_levels__0,cpi__tf_ctx__noise_levels__1,cpi__tf_ctx__noise_levels__2,cpi__tf_ctx__num_pels,cpi__tf_ctx__mb_rows,cpi__tf_ctx__mb_cols,cpi__tf_ctx__q_factor,cpi__rd__rdmult,cpi__rd__r0,cpi__mv_search_params__max_mv_magnitude,cpi__mv_search_params__mv_step_param,cpi__frame_info__frame_width,cpi__frame_info__frame_height,cpi__frame_info__mi_rows,cpi__frame_info__mi_cols,cpi__frame_info__mb_rows,cpi__frame_info__mb_cols,cpi__frame_info__num_mbs,cpi__frame_info__bit_depth,cpi__frame_info__subsampling_x,cpi__frame_info__subsampling_y,cpi__interp_search_flags__default_interp_skip_flags,cpi__interp_search_flags__interp_filter_search_mask,cpi__twopass_frame__mb_av_energy,cpi__twopass_frame__fr_content_type,cpi__twopass_frame__frame_avg_haar_energy,cpi__twopass_frame__stats_in__frame,cpi__twopass_frame__stats_in__weight,cpi__twopass_frame__stats_in__intra_error,cpi__twopass_frame__stats_in__frame_avg_wavelet_energy,cpi__twopass_frame__stats_in__coded_error,cpi__twopass_frame__stats_in__sr_coded_error,cpi__twopass_frame__stats_in__pcnt_inter,cpi__twopass_frame__stats_in__pcnt_motion,cpi__twopass_frame__stats_in__pcnt_second_ref,cpi__twopass_frame__stats_in__pcnt_neutral,cpi__twopass_frame__stats_in__intra_skip_pct,cpi__twopass_frame__stats_in__inactive_zone_rows,cpi__twopass_frame__stats_in__inactive_zone_cols,cpi__twopass_frame__stats_in__MVr,cpi__twopass_frame__stats_in__mvr_abs,cpi__twopass_frame__stats_in__MVc,cpi__twopass_frame__stats_in__mvc_abs,cpi__twopass_frame__stats_in__MVrv,cpi__twopass_frame__stats_in__MVcv,cpi__twopass_frame__stats_in__mv_in_out_count,cpi__twopass_frame__stats_in__new_mv_count,cpi__twopass_frame__stats_in__duration,cpi__twopass_frame__stats_in__count,cpi__twopass_frame__stats_in__raw_error_stdev,cpi__twopass_frame__stats_in__is_flash,cpi__twopass_frame__stats_in__noise_var,cpi__twopass_frame__stats_in__cor_coeff,cpi__twopass_frame__stats_in__log_intra_error,cpi__twopass_frame__stats_in__log_coded_error,tile_data__abs_sum_level,tile_data__allow_update_cdf,tile_data__tile_info__mi_row_start,tile_data__tile_info__mi_row_end,tile_data__tile_info__mi_col_start,tile_data__tile_info__mi_col_end,tile_data__tile_info__tile_row,tile_data__tile_info__tile_col,tile_data__firstpass_top_mv__row,tile_data__firstpass_top_mv__col,args__ref_frame_cost,args__single_comp_cost,args__skip_ifs,args__start_mv_cnt,args__interp_filter_stats_idx,args__wedge_index,args__wedge_sign,args__diffwtd_index,args__best_pred_sse,discard");
